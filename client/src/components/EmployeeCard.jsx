    ...
    <div className='group relative card card-hover overflow-hidden'>
        ...
        bg-linear-to-br from-slate-100 to-slate-50'>
            ...
            <div className='w-full h-full flex items-center justify-center'>
                ...
                from-indigo-100 to-slate-100 flex items-center
                justify-center'>
        ...
        <div className='absolute top-3 left-3 flex gap-2'>
            ...
            text-xs font-semibold text-slate-600 rounded-lg shadow-sm'>{employee.department || "Remote"}</span>
        ...
        {!employee.isDeleted && (
            ...
            justify-center pb-6 gap-3'>
                ...
                <button onClick={handleDelete} className='p-2.5 bg-white/90 backdrop-blur-sm
                text-slate-700 hover:text-rose-600 rounded-xl shadow-lg
                transition-all hover:scale-105 disable:opacity-50'>
