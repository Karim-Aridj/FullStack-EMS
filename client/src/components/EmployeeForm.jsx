        ...
        <div className="card p-5 sm:p-6">
            ...
            text-slate-700">
                ...
                <div>
                    ...
                    <input type="date"  name="joinDate" required defaultValue={initialData?.joinDate ? new Date(initialData.joinDate).toDateString().split('T')[0] : ""}/>
                </div>
                <div className="sm:col-span-2">
                    <label className="block mb-2">Bio (Optional)</label>
                    <textarea name="bio" required defaultValue={initialData?.bio} 
        ...
        <div className="card p-5 sm:p-6">
            ...
            text-slate-700">
                ...
                <div>
                    ...
                    <input name="firstName" required defaultValue={initialData?.position}/>
                </div>
                <div>
                ...
                <div>
                    ...
                    required defaultValue={initialData?.allowance || 0}/>
                </div>
                <div>
                    <label className="block mb-2">Deductions</label>
                    <input type="number" name="deductions" min="0" step="0.01"
                    required defaultValue={initialData?.deductions || 0}/>
                </div>
                {isEditMode && (
                    <div>
